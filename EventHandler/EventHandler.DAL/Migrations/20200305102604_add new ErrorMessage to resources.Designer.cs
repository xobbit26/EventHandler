...
namespace EventHandler.DAL.Migrations
{
    ...
    [Migration("20200305102604_add new ErrorMessage to resources")]
    partial class addnewErrorMessagetoresources
    {
            ...
            modelBuilder.Entity("EventHandler.DAL.Entities.Resource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "SuccessMessage_EventCreated",
                            Locale = "EN",
                            Text = "Event Successfully Created!"
                        },
                        new
                        {
                            Id = "ErrorMessage_InternalServer",
                            Locale = "EN",
